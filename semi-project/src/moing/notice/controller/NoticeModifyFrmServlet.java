...
/**
 * Servlet implementation class NoticeModifyFrmServlet
 */
@WebServlet(name = "NoticeModifyFrm", urlPatterns = { "/noticeModifyFrm" })
public class NoticeModifyFrmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeModifyFrmServlet() {
        super();
