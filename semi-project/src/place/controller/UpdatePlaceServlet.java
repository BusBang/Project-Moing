...
/**
 * Servlet implementation class UpdatePlaceServlet
 */
...
public class UpdatePlaceServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Place p = new Place();
		//#####Update에서는 memberId 필요없음 : 어차피 내가 제공한 장소글에서 아이디로 가지고 오기 때문에 단, 게시글의 번호는 필수
		p.setPlaceNo(Integer.parseInt(mRequest.getParameter("placeNo")));
