 ...
 */
@WebServlet(name = "MoimModifyFrm", urlPatterns = { "/moimModifyFrm" })
public class MoimModifyFrmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MoimModifyFrmServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/moim/moimModifyFrm.jsp").forward(request, response);
