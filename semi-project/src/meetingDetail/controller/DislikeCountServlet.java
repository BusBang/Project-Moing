...
/**
 * Servlet implementation class DislikeCountServlet
 */
@WebServlet(name = "DislikeCount", urlPatterns = { "/dislikeCount" })
public class DislikeCountServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DislikeCountServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int count = new MeetingDetailService().dislikes(meetingNo, memberId);
