...
<body>
	...
	<jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
        <div id="section">
			...
			<form id="frm" action="/moimModify" method="post" onsubmit="return submitTest()"  enctype="multipart/form-data">
			...
			<div id="sec1">
				...
				<div id="sec1-2">
					...
					<div id="nameDiv" style="width:49%; display:inline-block;">
						<span>*모임명</span><br>
						<input disabled id="nameInput" class="input-origin inputSizing" type="text" name="moimName" readonly value="${meeting.meetingName }" placeholder=" ${meeting.meetingName }">
...
<!-- 				<textarea name="ir1" id="ir1" rows="30" cols="150" style="resize: none; margin-top : 40px;"></textarea> -->
			...
			<div id="sec3">
				...
				<input type="submit" class="btn-xsm-orange2 btn-xsm-orange1" id="save" value="수정하기">
