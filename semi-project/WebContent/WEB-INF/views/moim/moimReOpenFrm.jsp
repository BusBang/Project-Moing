...
<body>
	...
	<jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
        <div id="section">
			...
			<form id="frm" action="/moimReOpen" method="post" onsubmit="return submitTest()" enctype="multipart/form-data">
			<input type="hidden" name="meetingNo" value="${meeting.meetingNo }">
			<div id="sec1">
				<div id="sec1-1">
					<div id="pic1">
						<c:if test="${not empty meeting.meetingFilepath }">
							<img id="img-view" src="/upload/${meeting.meetingFilepath }" width="478px" height="373px">						
						</c:if>
						<c:if test="${empty meeting.meetingFilepath }">
					...
					<div id="pic2">
						<label id="uploadLabel">
							...
							<c:if test="${not empty meeting.meetingFilepath }">
								<input type="file" id="uploadBtn" name="filename" style="display:none;" value="${meeting.meetingFilepath }" onchange="loadImg(this);">
							</c:if>
							<c:if test="${empty meeting.meetingFilepath }">							
				...
				<div id="sec1-2">
					...
					<div id="titleDiv" style="width:49%; display:inline-block;">
						<br><span>*글제목</span><span id="titleCount" style="font-weight:500; font-size:0.8em;">(${meetingTitleLength } / 최대 30자)</span><br>
						<input id="titleInput" class="input-origin inputSizing" type="text" name="moimTitle" value="${meeting.meetingTitle }" required placeholder=" [모집]매주 토요일 오후에 배드민턴 치실 20대">					
					</div>
					<div id="nameDiv" style="width:49%; display:inline-block;">
						<span>*모임명</span><br>
						<input id="nameInput" class="input-origin inputSizing" type="text" name="moimName" readonly value="${meeting.meetingName }" placeholder=" ${meeting.meetingName }">
					...
					<div id="peopleDiv" style="width:24%; display:inline-block;">
						...
						<input class="input-origin" id="peopleMinInput" type="text" placeholder=" [최소 인원] ex) 5" value="${meeting.meetingMinPerson }" name="minPerson"><br>
					</div>
					<div id="peopleDiv" style="width:24%; display:inline-block;">
						<br>
						<input required class="input-origin" id="peopleMaxInput" type="text" placeholder=" [최소 인원] ex) 25" value="${meeting.meetingMaxPerson }" name="maxPerson">
					</div>

					<div id="calDiv" style="width:49%; display:inline-block;">
						<span>*모임 개최일</span><br>
						<input  required type="text" id="datepicker1" name="date" size="20" class="input-origin" value="${meeting.meetingDate }" readonly>
				    ...
				    <div id="addrDiv">
						<span>*모임 장소</span>	<br>
							<!-- 우편번호가 들어가는 칸 -->
						<div>						
							<input type="text" name="addrCode" id="postCode" style="width:60px;display:inline-block;" class="input-origin" value="${meetingZipCode }" readonly> 
							<input type="text" name="addrRoad" id="roadAddr" style="width:250px;display:inline-block;" class="input-origin" value="${meetingRoadAddr }" readonly>
			...
			<div id="sec2">
				...
				<div id="sec2Textarea">
					<textarea rows="30" cols="150" id="ir1" name="content" style="margin-top:40px;">${meeting.meetingContent }</textarea>			
<!-- 				<textarea name="ir1" id="ir1" rows="30" cols="150" style="resize: none; margin-top : 40px;"></textarea> -->
			...
			<div id="sec3">
				...
				<input id="submitBtn" type="submit" class="btn-xsm-orange2 btn-xsm-orange1" id="save" value="재개최하기">
