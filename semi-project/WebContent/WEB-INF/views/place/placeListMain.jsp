...
<body>
		...
		<form action="/searchPlace" method="get">
			...
			<div class="container" style="width:1200px;">
				...
				<div class="input-group">
					<input type="text" class="form-control" style="font-weight:bold;" name="keyword" placeholder="게시글 제목을 입력하세요.">
			...
			<div id="container" class="collapse" style="width:1200px; margin:0 auto; padding-left:100px;">
				<table style="cellspacing:0; cellpadding:0; padding-left:100px;">
					...
					<tr>
						...
						<td>
							<select id="sel2" name="countryName" class="input-origin form-control" style="width:200px; margin-right:50px;">
		                    	<option value="">2차 지역명</option>
		                	</select>
						</td>
						<td>
						...
						<td>
							<input type="text" name="placeUseDate" class="form-control" autocomplete="off" readonly>
						</td>
					</tr>
				</table>
				<br><br><br>
	...
	<script>
		function check_click(check){
			if($(check).is(":checked")){
				$(check).parent().css("background-color","orange").css("color","white");
			}else{
				$(check).parent().css("background-color","").css("color","#656565");				
			}
		}
		...
		$("form").submit(function(){ 
			...
			$("input[name=check_option2]").val(check);
			
			if($("#sel1").val() != ""){ //1차 지역명을 선택했는데
				if($("#sel2").val() == ""){ //2차 지역명을 선택하지 않은 경우
					alert('2차 지역명을 선택하세요');
					$("#sel2").focus();
					return false;
				}
